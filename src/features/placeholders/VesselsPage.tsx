  ...
  return (
    <div className="p-6 max-w-7xl mx-auto space-y-6">
      <div className="flex flex-col md:flex-row items-baseline justify-between mb-2">
        <h1 className="text-2xl font-bold text-slate-900 tracking-tight">Vessels & ETAs</h1>
        <p className="text-xs text-slate-500 mt-1 md:mt-0">Track incoming vessels and manage port arrivals.</p>
      </div>
      ...
      <Card className="shadow-sm border-slate-200">
        ...
        <CardContent className="flex flex-col items-center justify-center py-24 text-center">
          ...
          <h2 className="text-sm font-semibold text-slate-800">No vessels tracked</h2>
          <p className="text-xs text-slate-500 mt-1 max-w-sm mb-4">
            Start tracking vessels to monitor ETAs and prevent demurrage. API integration with shipping lines coming soon.
          </p>
