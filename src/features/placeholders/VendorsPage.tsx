  ...
  return (
    <div className="p-6 max-w-7xl mx-auto space-y-6">
      <div className="flex flex-col md:flex-row items-baseline justify-between mb-2">
        ...
        <p className="text-xs text-slate-500 mt-1 md:mt-0">Manage terminal operators, shipping lines, and third-party vendors.</p>
      </div>
      ...
      <Card className="shadow-sm border-slate-200">
        ...
        <CardContent className="flex flex-col items-center justify-center py-24 text-center">
          ...
          <h2 className="text-sm font-semibold text-slate-800">No vendors found</h2>
          <p className="text-xs text-slate-500 mt-1 max-w-sm mb-4">
            You haven't added any third-party vendors to the directory yet.
          </p>
